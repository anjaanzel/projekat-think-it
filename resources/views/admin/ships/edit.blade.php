    ...
    <div class="container">
        <div class="row">
            <div class="card col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2 card-mt-15">
                <h4 class="center grey-text text-darken-2 card-title">Edit ship {{$ship->name}}</h4>
                <div class="card-content" style="width: 50%; margin: 0 auto;">
                    <div class="row">
                       
                        <form action="{{route('admin.ships.update', $ship)}}" method="POST" enctype="multipart/form-data">
                            <div class="input-field no-margin">
                            <i class="material-icons prefix">account_balance</i>
                     
                                <input type="text" name="name" id="name" class="validate" value="{{ $ship->name }}">
                            ...
                            <i class="material-icons prefix">account_balance</i>
                                ...
                                <input type="text" name="serial_no" id="serial_no" class="validate" value="{{ $ship->serial_no }}">
                            ...
                            <br><br>
                              ...
                              <div class="file-field input-field">
                                ...
                                <div class="file-path-wrapper">
                                  <input class="file-path validate" type="text" placeholder="Upload your file" value="{{$ship->image}}">
