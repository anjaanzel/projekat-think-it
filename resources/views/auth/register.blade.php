                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="input-field col s12 m6 l6 xl4">
                                ...
                                <input type="text" name="surname" id="surname" value="{{Request::old('surname') ? : ''}}">
                      ...
                      <select name="role">
                      <option value="" disabled>Chose rank of the crew member</option>
                      @foreach($roles as $role)
                        <!-- <div class='form-check'>
                          <input type="radio" name="role" id="role" value="{{old ('role') ? : $role->id}}">
